...
import com.qingting.protocol.mqttImp.MQTTDecoder.DecoderState;
...
import com.qingting.protocol.mqttImp.message.MessageType;
...
public class MQTTDecoder extends ReplayingDecoder<DecoderState> {
	...
	protected void decode(ChannelHandlerContext ctx, ByteBuf in,
		...
		case FIXED_HEADER:
			...
			System.out.println("handle2:"+fixedHeader);
			bytesRemainingInVariablePart = fixedHeader.getMessageLength();
			System.out.println("messageLength:"+bytesRemainingInVariablePart);
